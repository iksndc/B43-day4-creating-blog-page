...
function renderBlog() {
  ...
  for (let index = 0; index < data.length; index++) {
    ...
    <div class="blog-content">
      ...
      <div>
        <img style="height: 40px; margin: 40px 10px 40px 10px;" src="assets/andro1.png" alt="" />
        <img style="height: 40px; margin: 40px 10px 40px 10px;" src="assets/andro2.png" alt="" />
        <img style="height: 40px; margin: 40px 10px 40px 10px;" src="assets/andro3.png" alt="" />
      </div>  
    </div>
    <div class="btn-group">
